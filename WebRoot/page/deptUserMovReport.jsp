...
<%@include file="header.jsp" %>
        ...
        <div class="content">   
            ...
            <div class="breadLine">
                <ul class="breadcrumb">
                    <li><a href="#">主页</a> <span class="divider">></span></li><li><a href="#">报表管理</a> <span class="divider">></span></li><li class="active">部门调动员工报表</li>
                </ul>
                <ul class="buttons">              
                    <li>
            ...
            <div class="workplace">
                ...
                <div class="page-header">
                    <h1>部门调动员工报表<small>And 查询</small></h1>
                </div> 
                <div class="row-fluid">
                    <div class="span8">                    
                        <div class="head clearfix">
                        ...
                        <div class="block-fluid">
                            <table cellpadding="0" cellspacing="0" width="100%" class="table">
                                <thead>
                                    <tr> 
                                        <th width="15%">序号</th>
                                        <th width="15%">原部门名称</th>
                                        <th width="15%">新部门名称</th>
                                        <th width="15%">姓名</th>
                                        <th width="10%">性别</th> 
                                        <th width="15%">调动日期</th>
                                        <th width="15%">调动原因</th>                                    
