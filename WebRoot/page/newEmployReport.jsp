...
<%@include file="header.jsp" %>
        ...
        <div class="content">   
            ...
            <div class="breadLine">
                <ul class="breadcrumb">
                    <li><a href="#">主页</a> <span class="divider">></span></li><li><a href="#">报表管理</a> <span class="divider">></span></li><li class="active">新聘员工报表</li>
                </ul>
                <ul class="buttons">              
                    <li>
            ...
            <div class="workplace">
                ...
                <div class="page-header">
                    <h1>新聘员工报表<small>And 查询</small></h1>
                </div> 
                <div class="row-fluid">
                    <div class="span8">                    
                        <div class="head clearfix">
