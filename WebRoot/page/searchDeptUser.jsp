...
<%@include file="header.jsp" %>
        ...
        <div class="content">   
            ...
            <div class="breadLine">
                <ul class="breadcrumb">
                    <li><a href="index.jsp">主页</a> <span class="divider">></span></li><li><a href="deptAction!showDeptList">部门管理</a> <span class="divider">></span></li><li class="active">查询部门下属员工信息</li>
                </ul>
                <ul class="buttons">              
                    <li>
                    ...
                    <div class="span9">
                        ...
                        <div class="block-fluid">                        
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="span2"><input type="text" disabled="disabled" placeholder="员工编号"/></div>
                                <div class="span1">姓名:</div>
                                <div class="span2"><input type="text" disabled="disabled" placeholder="姓名"/></div>
                                ...
                                <div class="span2"><input type="text" disabled="disabled" placeholder="出生日期"/></div>
                            </div> 
                            <div class="row-form clearfix">
                                <div class="span1">身份证号:</div>
                                <div class="span3"><input type="text" disabled="disabled" placeholder="身份证号"/></div>
                                ...
                                <div class="span2"><input type="text" disabled="disabled" placeholder="岗位"/></div>
                            </div> 
                            <div class="row-form clearfix">
                                <div class="span1">入职日期:</div>
                                <div class="span3"><input type="text" disabled="disabled" placeholder="入职日期"/></div>        
                                <div class="span2">参加工作日期:</div>
                                <div class="span2"><input type="text" disabled="disabled" placeholder="参加工作日期"/></div>
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="span3"><input type="text" disabled="disabled" placeholder="籍贯"/></div>
                                <div class="span1">联系电话:</div>
                                <div class="span3"><input type="text" disabled="disabled" placeholder="联系电话"/></div>
                                <div class="span1">电子邮件:</div>
                                <div class="span3"><input type="text" disabled="disabled" placeholder="电子邮件"/></div>
                            </div> 
                            <div class="row-form clearfix">
                                <div class="span1">身高:</div>
                                <div class="span1"><input type="text" disabled="disabled" placeholder="身高"/></div>        
                                ...
                                <div class="span5"><input type="text" disabled="disabled" placeholder="出生地"/></div>                 
                            </div> 
                            <div class="row-form clearfix">
                                <div class="span2">户口所在地:</div>
                                <div class="span4"><input type="text" disabled="disabled" placeholder="户口所在地"/></div>
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="span3"><input type="text" disabled="disabled" placeholder="毕业院校"/></div>
                                <div class="span1">所学专业:</div>
                                <div class="span3"><input type="text" disabled="disabled" placeholder="所学专业"/></div>
                                <div class="span1">毕业日期:</div>
                                <div class="span3"><input type="text" disabled="disabled" placeholder="毕业日期"/></div>
                            </div> 
                            <div class="row-form clearfix">
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="span10"><textarea name="textarea" disabled="disabled" placeholder="试用期部门考核评语"></textarea></div>
                            </div>  
                            <div class="row-form clearfix">
                                ...
                                <div class="span3"><input type="text" disabled="disabled" placeholder="处理日期"/></div>
                            </div> 
                            <div class="row-form clearfix">
                                <div class="span1">备注:</div>
                                <div class="span11"><textarea name="textarea" disabled="disabled" placeholder="备注"></textarea></div>
                            </div>                          
                        </div>
                    </div>
                    <div class="span3">
